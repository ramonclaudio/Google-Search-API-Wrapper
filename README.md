...
3. Submit the report [here](https://github.com/ramonclaudio/Google-Search-API-Wrapper/issues).
...
3. Submit the request [here](https://github.com/ramonclaudio/Google-Search-API-Wrapper/issues).
